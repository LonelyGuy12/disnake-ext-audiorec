...
if not IS_READTHEDOCS:
    ...
    kwargs.update({"rust_extensions": [RustExtension('disnake.ext.audiorec.ffi')]})

CURDIR = Path(os.path.dirname(__file__))
PROJECT_ROOT = CURDIR / 'disnake' / 'ext' / 'audiorec'
...
setup(
    name='disnake-ext-audiorec',
    author='LonelyGuy12',
    license='MIT',
    author_email='phoenex659@gmail.com',
    classifiers=CLASSIFIERS,
    description='A disnake experimental extention for audio recording',
    long_description=LONG_DESCRIPTION,
    long_description_content_type='text/x-rst',
    install_requires=REQUIRES,
    extras_require=EXTRA_REQUIRES,
    setup_requires=SETUP_REQUIRES,
    packages=['disnake.ext.audiorec'],
    python_requires='>=3.6.0',
    url='https://github.com/LonelyGuy12/disnake-ext-audiorec',
    version=VERSION,
