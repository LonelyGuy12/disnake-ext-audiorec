.. disnake-ext-audiorec documentation master file, created by
   sphinx-quickstart on Mon Apr 26 20:09:30 2021.
   You can adapt this file completely to your liking, but it should at least
   contain the root `toctree` directive.

Welcome to disnake-ext-audiorec's documentation!
================================================

disnake-ext-audiorec is an extension
package that provides recording feature
to `disnake.py <https://disnake.readthedocs.io/ja/latest/>`_
voice client.


This package works by setting
``cls=NativeVoiceClient`` as an argument
when you connect to a disnake voice channel.
